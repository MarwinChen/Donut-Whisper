...
# srt_root = "/hdd/srt11/data_8844/SRT_kurz/"
# video_root = "/hdd/srt11/data_8844/Video_kurz"
# output_dir = "/hdd/srt11/data_8844/Cut2"

output_json = "/hdd/srt11/data_8844/ValS02.json"

all_srt = {}
srt_files = os.listdir(srt_root)
video_files = os.listdir(video_root)
for srt_file in srt_files:
    if int(srt_file[4:6]) == 22:
    # if True:
            ...
            for entry in entries:
                ...
                if len(lines) >= 3:
                    ...
                    if match:
                        ...
                        #     result.append((start_time, end_time, subtitle, subtitle_zh))
                        result.append((start_time, end_time, subtitle))
...
def process(i):
    ...
    video_name = os.path.basename(video_path).split(".")[3]
